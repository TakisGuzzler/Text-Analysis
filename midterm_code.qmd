...
kable(var_importance_results["ChatGPT"], caption = "Top 5 Important Features for ChatGPT") %>% kable_styling(latex_options = "striped") %>%
  row_spec(0, extra_css = "margin-bottom: 0px; padding-bottom: 0px;") %>% kable_styling(latex_options = "HOLD_position")
```
```{r}
kable(var_importance_results["Meta LLaMA 70B Instruct"], caption = "Top 5 Important Features for Meta LLaMA 70B  Instruct") %>% kable_styling(position = "center", latex_options = "striped") %>%
  row_spec(0, extra_css = "margin-bottom: 0px; padding-bottom: 0px;") %>% kable_styling(latex_options = "HOLD_position")


kable(var_importance_results["Meta LLaMA 70B"], caption = "Top 5 Important Features for Meta LLaMA 70B") %>% kable_styling(position = "center", latex_options = "striped") %>%
  row_spec(0, extra_css = "margin-bottom: 0px; padding-bottom: 0px;") %>% kable_styling(latex_options = "HOLD_position")
