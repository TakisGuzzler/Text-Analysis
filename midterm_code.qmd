...
```{r}
####read in biber data ####
chunk_biber <- read.table("hape_sample/biber_data/biber_chunk_2.tsv", header=TRUE, sep='\t', quote="", fill=TRUE)

gpt_4o_biber <- read.table("hape_sample/biber_data/biber_gpt-4o-2024-08-06.tsv", header=TRUE, sep='\t', quote="", fill=TRUE)

meta_llama_3_biber <- read.table("hape_sample/biber_data/biber_Meta-Llama-3-8B.tsv", header=TRUE, sep='\t', quote="", fill=TRUE)

arxiv_biber <- read.table("arxiv_sample/arxiv_biber.tsv", header=TRUE, sep='\t', quote="", fill=TRUE)
```
