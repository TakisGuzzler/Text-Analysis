...
kable(var_importance_results["ChatGPT"], caption = "Top 5 Important Features for ChatGPT")
kable(var_importance_results["Meta LLaMA 70B Instruct"], caption = "Top 5 Important Features for Meta LLaMA 70B  Instruct")
kable(var_importance_results["Meta LLaMA 70B"], caption = "Top 5 Important Features for Meta LLaMA 70B")
```
