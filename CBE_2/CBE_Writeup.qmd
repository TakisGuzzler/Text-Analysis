...
The average lexical density for the texts from the 1850s is 0.4817, while for the 1950s, it is 0.4976. This indicates a small increase in lexical density over time, suggesting a slight rise in the proportion of content words in the 1950s texts. Content words are words that carry meaning in a sentence, while function words are more for grammatical purposes. Lexical density is higher when the proportion of content words is greater than that of function words. However, given the minimal difference between the two decades, this change is unlikely to have a significant impact on the readability or complexity of the texts. A larger dataset would be needed to draw more definitive conclusions, since our sample size is relatively small.
