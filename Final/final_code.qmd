...
```{r fig.cap="Relative Frequency of Grammatical Adjective Noun Pattern Over Time", out.height = "30%"}
...
```{r fig.cap="Relative Frequency of Grammatical Noun Noun Pattern Over Time", out.height = "30%"}
...
```{r fig.cap="Relative Frequency of Prepositional Phrases with Nouns Over Time", out.height = "30%"}
