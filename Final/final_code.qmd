...
pattern_counts_nn <- data.frame(decade = c(1850, 1875, 1900, 1925, 1950),
                                RF = sub_anno_mean_nn)
...
From Figure 3, the relative frequency of adjective-noun phrases slightly decreased from the mid-1800s to the mid-1900s, declining from a relative frequency of 8 in the 1850s to around 7.2 in the 1950s. This suggests a slight reduction in grammatical complexity, potentially reflecting a shift in writing style toward simpler and more direct expressions. We additionally ran a correlation test between the dates and relative frequencies of the phrases. The Pearson Correlation Coefficient for relative frequency of noun + noun phrases over time is $0.0607$, which implies a very slight positive correlation for the data.
...
pattern_counts_an <- data.frame(decade = c(1850, 1875, 1900, 1925, 1950),
                                RF = sub_anno_mean_an)
...
pattern_counts_p <- data.frame(decade = c(1850, 1875, 1900, 1925, 1950),
                                RF = sub_anno_mean_p)
