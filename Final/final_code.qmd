...
kable(lexical_density_data, caption = "Average Lexical Density from the Mid 1800s to the Mid 1900s")
...
kable(lex_div_res, caption = "Average Lexical Diversity from the Mid 1800s to the Mid 1900s")
...
```{r fig.cap="Relative Frequency of Prepositional Phrases with Nouns Over Time", out.height = "28%"}
