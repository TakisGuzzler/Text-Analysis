...
```{r fig.cap="Average Sentence Length of Short Stories from mid 1800s to mid 1900s", out.height = "40%"}
library(stringr)
library(dplyr)
library(ggplot2)
...
```{r fig.cap="Average Word Length of Short Stories from mid 1800s to mid 1900s", out.height = "40%"}
