...
ggplot(df_AN, aes(x = decade, y = RF, group = 1)) +
  ...
  geom_point(color = "blue") +
  labs(
    title = "Relative Frequence of Grammatical Adjective Noun Pattern Over Time",
    x = "Year",
...
ggplot(df_NN, aes(x = decade, y = RF, group = 1)) +
  ...
  geom_point(color = "blue") +
  labs(
    title = "Relative Frequence of Grammatical Noun Noun Pattern Over Time",
    x = "Year",
    y = "Relative Frequency"
  ) +
  theme_minimal() +
...
ggplot(df_P, aes(x = decade, y = RF, group = 1)) +
  ...
  geom_point(color = "blue") +
  labs(
    title = "Relative Frequence of Prepositional Use Over Time",
    x = "Year",
    y = "Relative Frequency"
  ) +
  theme_minimal() +
