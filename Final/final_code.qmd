...
Finally, we investigated the grammatical complexity of each of the periods. To do so, we split the corpora according to their part of speech tags using udpipe and further categorized them according to unique phrases. The unique phrases were matched to two different regex expressions - one for identifying simple noun phrases and another for identifying simple verb phrases. From there, we calculated the relative frequency of four patterns in the text - *AN*, *NN*, and *P*. *AN* matches to Adjective Noun phrases, *NN* matches to Noun Noun phrases, *P* matches to prepositional phrases. We chose to investigate adj + noun and noun + noun patterns because they are commonly recognized to represent 'phrasal' complexity in writing. Similarly, we chose to investigate the relative frequency of prepositions to account for the prevalence of propositional phrases in the texts. These were specifically considered because they are common signals of 'clausal' complexity (@Biber_Gray_2016).
