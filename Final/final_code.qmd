...
all_text1950 <- paste(txt_1940, txt_1942, txt_1945, txt_1948, txt_1950, txt_1950b, txt_1950c, txt_1951, txt_1952, txt_1952b, txt_1954, txt_1954b, txt_1955)
words1950s <- unlist(strsplit(all_text1950, "\\s+"))
...
```{r}
lexdiv_ss_1850 <- textstat_lexdiv(dfm_short_stories_1850, measure = c("CTTR", "U", "K", "Mass"))

lexdiv_ss_195050 <- textstat_lexdiv(dfm_short_stories_1950, measure = c("CTTR", "U", "K", "Mass"))
...
lex_div_res <- data.frame(
  Decade = c("Mid 1800s", "Mid 1900s"),
  CTTR = c( round(mean(lexdiv_ss_1850$CTTR), 3),
                   round(mean(lexdiv_ss_1950$CTTR), 3)
  ),
  Uber_Index = c(round(mean(lexdiv_ss_1850$U), 3),
                round(mean(lexdiv_ss_1950$U), 3)
  ),
  Yule_index = c(round(mean(lexdiv_ss_1850$K), 3),
                round(mean(lexdiv_ss_1950$K), 3)
  )
)
